	...
	<div class="container h-100">
		<div class="auth__column form-column d-flex justify-content-center flex-columns h-100 align-items-center">
			<div class="auth-form w-100" style="max-width:520px;text-align:center">
				<h3 class="auth-form__title mb-4">Добро пожаловать!</h3>
				...
				<form class="form" action="<?= $results['form']['action'] ?>" method="post">
					...
					<input class="form__field form-control mb-3" name="user[password]" type="password" required id="password" placeholder="Пароль">

					<button class="btn btn-primary mb-3 auth-form__button login-btn" type="submit" name="<?= $results['form']['btn'] ?>">Войти</button>
					...
					<div class="auth-btn-wrapper">
						<a href="/user/registration" class="create-account-btn text-muted d-block"><small>Создать аккаунт</small></a>
						<a href="/user/restore_password" class="restore-pass text-muted d-block"><small>Забыли свой пароль?</small></a>
					</div>
				</form>
			</div>
		</div>
